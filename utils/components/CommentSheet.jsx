  ...
  return (
    <View style={styles.commentRow}>
      {item.profilePhotoUrl ? (
        <Image source={item.profilePhotoUrl} style={styles.pfp} />
      ) : (
...
export const CommentSheet = ({ visible, post, onClose, refetchPosts }) => {
  ...
  const { comments, loading, fetchComments, createComments, deleteComments } =
    useComments();
        ...
        >
          ...
          <View style={styles.inputRow}>
            {user.profilePhotoUrl ? (
              <Image source={user.profilePhotoUrl} style={styles.pfp} />
            ) : (
              <View style={styles.pfpWrapper}>
                <LottieView
                  source={require("../../assets/images/profilePic1.json")}
