      ...
      >
        ...
        {!loading && user && (
          ...
          >
            {user?.profilePhotoUrl ? (
              <Image source={user.profilePhotoUrl} style={styles.image} />
            ) : (
        ...
        <View style={styles.postInputBox}>
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            <Text style={{ color: "#ABABAC", marginTop: 12 }}>
              {title.length}/{maxCharsInTitle}
            </Text>
          </View>
          ...
          <View style={{ flexDirection: "row" }}>
            ...
            />
            <Text style={{ color: "#ABABAC", marginTop: 12 }}>
              {description.length}/{maxCharsInDesc}
            </Text>
          </View>
          ...
          >
            ...
            <View style={{ marginTop: 30, width: "48%" }}>
              ...
              >
                ...
                <MaterialIcons
                  name={
                    isOpenGender ? "keyboard-arrow-up" : "keyboard-arrow-down"
                  }
                  size={24}
                  color="#555"
                />
          ...
          <View style={{ marginVertical: 20 }}>
            ...
            {image.length < 4 && (
              ...
              >
                <Text style={{ color: "#ABABAC", fontSize: 16 }}>
