...
const PeopleMissingHistory = () => {
    ...
    const { data, loading, error, refetch} = useFetchHistory(
        `${BASE_URL}/request/my/missingpeople`
    )
    ...
    return (
        <View style={[styles.container, { paddingTop: insets.top }]}>
            <View style={styles.topBar}>
                ...
                <Text style={styles.heading}>People Missing</Text>
                ...
                {!loading && data && data.length === 0 &&  (
                    <View style={{ marginTop: '30%', alignItems: 'center' }}>
                        <LottieView
                            ...
                            style={styles.animation}
                        />
                        <Text style={{ marginTop: 10, fontSize: 18 }}>No data available.</Text>
                        <Text style={{ marginTop: 10, fontSize: 18,textAlign:'center' }}>Add a report when required.</Text>
                        <TouchableOpacity
                            style={styles.createPostbtn}
                            onPress={() => router.push('/createPeopleMissing')}
                        >
                            <Ionicons
...
export default PeopleMissingHistory;
