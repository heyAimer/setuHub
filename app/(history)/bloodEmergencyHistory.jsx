...
const BloodEmergency = () => {
  ...
  const { data, loading, error, refetch } = useFetchHistory(
    `${BASE_URL}/request/my/bloodemergency`,
  );
        ...
        {!loading && data && data.length === 0 && (
          <View style={{ marginTop: "30%", alignItems: "center" }}>
            ...
            <Text style={{ marginTop: 10, fontSize: 18, textAlign: "center" }}>
              Raise a blood request when required.
            </Text>
            <TouchableOpacity
            ...
            >
              ...
              <Text style={{ color: "white", fontWeight: 500 }}>Request</Text>
            </TouchableOpacity>
          </View>
        )}
              ...
              <View style={styles.postContainer} key={info.postUuid}>
                ...
                >
                  {info?.profilePhotoUrl ? (
                    <Image source={info.profilePhotoUrl} style={styles.pfp} />
                  ) : (
                  ...
                  <View style={{ marginLeft: 8 }}>
                    ...
                    <Text style={{ fontSize: 14, color: "#5F6368" }}>
                      {convertUTCtoIST(info.createdAt)}
                    </Text>
                  </View>
                </View>
                <View>
                ...
                >
                  <TouchableOpacity
                    style={[styles.modifybtn, styles.delete]}
                    onPress={() => handleDelete(info.postUuid)}
                  >
                    <MaterialIcons
                      name="delete-outline"
                      size={14}
                  ...
                  {info.done ? (
                    <TouchableOpacity
                      style={[styles.modifybtn, styles.completed]}
                      onPress={() => handleCompleted(info.postUuid)}
                    >
                      <MaterialIcons
                    ...
                    <TouchableOpacity
                      style={[styles.modifybtn, styles.done]}
                      onPress={() => handleDone(info.postUuid)}
                    >
                      <MaterialIcons
                        name="done-outline"
                        size={14}
